...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "anyonecancreate"                  , "anyone-can-create"                ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10006, 0, "-mc-anyonecancreate",
                   "anyonecanissue","",
    ...
    { "anyonecanmine"                     , "anyone-can-mine"                   ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10001, 0, "-mc-anyonecanmine",
                   "anyonecanactivate","",
                   "Anyone can mine blocks (confirm transactions)."},
    { "anyonecanactivate"                 , "anyone-can-activate"                   ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10003, 0, "-mc-anyonecanactivate",
                   "anyonecanadmin","",
                   "Anyone can grant or revoke connect, send and receive permissions."},
    { "anyonecanadmin"                     , "anyone-can-admin"                   ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10001, 0, "-mc-anyonecanadmin",
